...
# ===========================================================================
HOST = "Seyyed-Mahdi-Sepahbodi"   # shown as  mithun@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Python Developer/Enthusiast of Networking and Cybersecurity"),
    # ("kv", "Also", "Co-Founder @ Quilonix"),
    ("kv", "Loc", "Mashhad, Iran"),
    # ("kv", "Site", "mithungowda.in"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Backend", "Django, FastAPI, Python"),
